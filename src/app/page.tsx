      ...
      <section className="relative px-8 py-16 md:py-24 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 space-y-8 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-4">
            ...
            <div className="bg-white px-5 py-3 rounded-full shadow-[0_2px_10px_rgba(0,0,0,0.06)] border border-gray-100 flex items-center space-x-3 w-fit">
              <div className="flex items-center">
                ...
                <span className="font-bold text-[#202124] text-lg ml-2 leading-none mt-0.5">
                  5.0
                </span>
              </div>
              ...
              <span className="text-[15px] font-medium text-[#5F6368] ml-1">
                Reseñas de Google
              </span>
            </div>
          </div>
        ...
        <div className="flex-1 relative w-full min-h-[400px] md:min-h-[500px] mt-10 md:mt-0">
          <div className="absolute inset-0 bg-blue-50/50 rounded-[40px] transform rotate-3 scale-105 -z-10" />
          <div className="absolute inset-0 bg-mt-dark rounded-[32px] overflow-hidden shadow-2xl">
            <Image
              src="/ImagenHero.png"
